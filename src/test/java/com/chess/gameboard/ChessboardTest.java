...
public class ChessboardTest {
    ...
    public void testInitChessGame() {
        ...
        Assert.assertThat(chessboard.toString(), CoreMatchers.allOf(
                CoreMatchers.containsString("A1")
                , CoreMatchers.containsString("B2")
                , CoreMatchers.containsString("C3")
                , CoreMatchers.containsString("D4")
                , CoreMatchers.containsString("E5")
                , CoreMatchers.containsString("F6")
                , CoreMatchers.containsString("G7")
                , CoreMatchers.containsString("H8")
        ));
    }
